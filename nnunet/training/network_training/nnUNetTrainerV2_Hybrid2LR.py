...
# Also took code from https://github.com/Project-MONAI/research-contributions/blob/main/UNETR/BTCV/optimizers/lr_scheduler.py
...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    '''
        Code taken from 
        https://github.com/Project-MONAI/research-contributions/blob/main/UNETR/BTCV/optimizers/lr_scheduler.py
    '''
    def __init__(
        self,
        optimizer: Optimizer,
